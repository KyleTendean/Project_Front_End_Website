    ...
    <div className='footer py-5'>
      <Container>
        <Row className='d-flex justify-content-between'>
          ...
          <h5 className='fw-bold mb-3'>Subscribe untuk terus terhubung dengan kami</h5>
        ...
        <Row>
          <Col>
            <p className='text-center px-md-0 px-3'>&copy; Copyright {new Date().getFullYear()} 
            by <span className='fw-bold'>Kesehatan +</span> Mastery,All Right Reserve</p>
          </Col>
        </Row>
      </Container>
    </div>
