      ...
      <header className="w-100 min-vh-100 d-flex align-items-center overflow-hidden">
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            ...
            animate__delay-1s">
            <span> Selamat datang di MjoCoding</span>  
            </h2>
            <p className="mb-4 animate__animated animate__fadeInUp 
            animate__delay-1s">tempat terbaik untuk membuka pintu dunia pemrograman!</p>
            <button className='btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 
            mb-2 animate__animated animate__fadeInUp animate__delay-1s' onClick={() => navigate("/kelas")}>Cek Kelas</button>
            <button className='btn btn-outline-danger btn-lg rounded-1 me-2 mb-xs-0 
            mb-2 animate__animated animate__fadeInUp animate__delay-1s' onClick={() => navigate("/testimonial")}>Mentor</button>
            </Col>
            <Col lg="6">
      ...
      <Container>
        ...
        <Row>
          {kelasTerbaru.map((kelas)=> {
            ...
            rounded data-aos='fade-up' data-aos-duration='1000'
        ...
        <Row>
          <Col className='text-center'>
            ...
            onClick={() => navigate('/kelas')}>Daftar Kelas
